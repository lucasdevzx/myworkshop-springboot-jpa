...
@RequestMapping(value = "/categories") // Define um meio de acesso para o recurso implementado
public class CategoryResource {
    ...
    public ResponseEntity<Category> findById(@PathVariable Long id) { // Permite que o parâmetro do http se atribua ao objeto
